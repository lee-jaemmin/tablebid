...
class InviteCodeCard extends StatelessWidget {
  ...
  InviteCodeCard({super.key, required this.company, required this.onCompanyChanged});
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              // DB 업데이트
              try {
                final updatedCompany = await CompanyApi().regenerateInviteCode(companyId: companyId);
